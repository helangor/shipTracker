...
#Calculates the difference between two coordinate points in km
...
#Changes ship type from number value to text
...
def fetch_ships():
    ...
    #Getting more specific shipdata from different API
